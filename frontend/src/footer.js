...
const Footer = ()=>
{
    ...
    <footer>
        <div className='footerBlock'>
            <div className='icons'>
                <div><a href="" target="_blank"><FontAwesomeIcon icon={faFacebook} className='facebook'/></a></div>
                <div><a href="" target="_blank"><FontAwesomeIcon icon={faInstagram} className='instagram'/></a></div>
                <div><a href="" target="_blank"><FontAwesomeIcon icon={faTwitter} className='twitter'/></a></div>
            </div>
